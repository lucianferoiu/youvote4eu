	...
	public void generateQuestions() {
		...
		try {
			...
			for (int i = 0; i < howMany; i++) {
				...
				q.setBoolean("is_published", random.nextBoolean() || random.nextBoolean());//~ three quarters are archived are published
				q.setBoolean("is_archived", q.getBoolean("is_published") && (random.nextBoolean() && random.nextBoolean()));// .. and ~ a quarter are archived
				q.setLong("support",
