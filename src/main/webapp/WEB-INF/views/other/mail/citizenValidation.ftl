...
<html>
	<body>
		...
		<div class="content">
			...
			<p>
				To finalize the validation and make your votes count, <a href="${url}">please click here</a>.
				<br/>
				Make sure to do so in the next 24h, since afterwards the code will be deleted and the validation process halted.
			</p>
			<p>
				If you're unable to see the link or cannot open the link in your browser, paste this<br/>
				<tt>${url}</tt><br/>
