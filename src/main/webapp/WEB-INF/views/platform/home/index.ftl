...
[@content for="title"]You Vote For Europe - Partners Platform[/@content]
...
<div class="container">
	<div class="jumbotron">
		<h2>Welcome to the Partners Platform section of <span class="text-primary">YouVoteForEurope</span></h2>
		<p> </p>
		<p>We count on your help to improve the quality of the questions we present to the EU citizens.</p>
		<p> </p>
		<p>Editing and refining the text and details of the questions proposed by you or other partners,
