...
CREATE TABLE IF NOT EXISTS email_validations (
	...
	/* - */
	email VARCHAR(120) NOT NULL,						/* email to be validated - digested information, no clear-text email addresses */
	token VARCHAR(250) NOT NULL, 						/* a randomly-generated unique string sent to email address and expecting to be returned by HTTP(S) */
